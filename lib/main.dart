...
import 'package:samsungf/signal_transmit.dart';
      ...
      child: Consumer(
        builder: (context, ref, _) {
          return MaterialApp(
            ...
            home: const SamsungRemoteControl(),
          );
        },
      ),
    );
...
class SamsungRemoteControl extends StatelessWidget {
  const SamsungRemoteControl({Key? key}) : super(key: key);
